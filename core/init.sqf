...
//Force disable of certain channels because description.ext doesn't work.
...
12 enableChannel [false,false];
13 enableChannel [false,false];
14 enableChannel [false,false];
15 enableChannel [false,false];
