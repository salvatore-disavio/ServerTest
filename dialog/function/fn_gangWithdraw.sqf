...
_porcodio = (group player getVariable "gang_owner");//solo il capo puo prelevare
...
if (_porcodio != getPlayerUID player) exitWith {hint "Solo il capo gang puo prelevare i soldi"};
